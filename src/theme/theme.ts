...
const Inter_Regular = '../assets/fonts/Inter/Inter-Regular.ttf';
const Inter_SemiBold = '../assets/fonts/Inter/Inter-SemiBold.ttf';
const Inter_Bold = '../assets/fonts/Inter/Inter-Bold.ttf';
